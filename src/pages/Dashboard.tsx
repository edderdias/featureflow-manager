...
import { User, Calendar, CheckSquare, Paperclip, Plus, Search, Loader2 } from "lucide-react";
            ...
            {columns.map((status) => {
              ...
              return (
                <KanbanColumn 
                  ...
                  demands={display} 
                  totalDemandsCount={colDemands.length} 
                  onEdit={handleEdit} 
          ...
          <DragOverlay>
            {activeDragId ? (
              <div className="w-[280px]">
                <DraggableDemandCard demand={demands!.find(d => d.id === activeDragId)!} onEdit={handleEdit} />
              </div>
            ) : null}
          </DragOverlay>
        </DndContext>
