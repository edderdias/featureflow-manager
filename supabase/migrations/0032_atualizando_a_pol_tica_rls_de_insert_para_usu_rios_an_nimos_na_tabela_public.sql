...
-- Permitindo que creator_name seja igual a client_name e creator_email igual a client_email.
...
WITH CHECK (
  ...
  creator_name = client_name AND -- Permitir que creator_name seja preenchido com client_name
  creator_email = client_email AND -- Permitir que creator_email seja preenchido com client_email
  due_date IS NULL AND
  story_points IS NULL AND
  sprint IS NULL AND
