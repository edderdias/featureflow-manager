...
-- Adicionando checks explícitos para creator_name, creator_email, due_date, story_points, sprint e completed_at serem NULL.
...
WITH CHECK (
  ...
  creator_name IS NULL AND
  creator_email IS NULL AND
