...
DROP POLICY IF EXISTS "Allow users to insert their own demands, technicians/admins to insert any, and anonymous clients to insert client demands" ON public.demands;
...
WITH CHECK (
  user_id IS NULL AND client_email IS NOT NULL
);
